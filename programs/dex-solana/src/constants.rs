...
pub const REDEEM_SELECTOR: &[u8; 8] = &[184, 12, 86, 149, 70, 196, 97, 225];
...
pub const HUMIDIFI_SWAP_WITH_USER_DATA_SELECTOR: u8 = 0x14;
...
pub const TAURUSFI_SWAP_SELECTOR: &[u8; 1] = &[5];

pub const SWAP_SELECTOR_02: &[u8; 1] = &[2]; // 02
pub const GOONFI_SWAP_SELECTOR: &[u8; 1] = SWAP_SELECTOR_02;
pub const SCORCH_SWAP_SELECTOR: &[u8; 1] = SWAP_SELECTOR_02;
pub const BISONFI_SWAP_SELECTOR: &[u8; 1] = SWAP_SELECTOR_02;
...
pub const GOONFI_V2_SWAP_SELECTOR: &[u8; 1] = &[1];
pub const QUANTUM_SWAP_SELECTOR: &[u8; 1] = &[7];
...
pub mod whalestreet_program {
    use anchor_lang::declare_id;
    declare_id!("FW6zUqn4iKRaeopwwhwsquTY6ABWLLgjxtrC3VPnaWBf");
}
...
// Scorch (frontend program + backend/oracle program)
pub mod scorch_program {
    use anchor_lang::declare_id;
    declare_id!("SCoRcH8c2dpjvcJD6FiPbCSQyQgu3PcUAWj2Xxx3mqn");
}

pub mod jupiter_lend_program {
    use anchor_lang::declare_id;
    declare_id!("jup3YeL8QhtSx1e253b2FDvsMNC87fDrgQZivbrndc9");
}

pub mod taurusfi_program {
    use anchor_lang::declare_id;
    declare_id!("9VX8EKBg6vM6tA68xaDsPkbrx26XConZjkQmhVApUptc");
}

pub mod bisonfi_program {
    use anchor_lang::declare_id;
    declare_id!("BiSoNHVpsVZW2F7rx2eQ59yQwKxzU5NvBcmKshCSUypi");
}

pub mod goonfi_v2_program {
    use anchor_lang::declare_id;
    declare_id!("goonuddtQRrWqqn5nFyczVKaie28f3kDkHWkHtURSLE");
}

pub mod quantum_program {
    use anchor_lang::declare_id;
    declare_id!("QuaNtZsgYRe5Z9Bk4LZ4cTD9tbkVoyCNf1R2BN9bBDv");
}
