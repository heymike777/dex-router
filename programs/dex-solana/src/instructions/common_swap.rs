...
pub enum Dex {
    ...
    FutarchyAmm,
    PumpfunSell2,
    #[strum(to_string = "HumidifiSwap2")]
    HumidifiSwap2 {
        swap_id: u64,
    },
    #[strum(to_string = "Scorch")]
    Scorch {
        id: u128,
    },
    JupiterLendDeposit,
...
pub fn common_swap<'info, T: CommonSwapProcessor<'info>>(
    ...
    // before swap hook
    let actual_amount_in = swap_processor.before_swap(
        owner,
        source_token_account,
        source_mint,
        source_token_sa,
...
pub fn common_swap_v3<'info, T: PlatformFeeV3Processor<'info>>(
    ...
    // before swap hook
    let (actual_amount_in, from_commission_amount, from_platform_fee_amount) = swap_processor
        .before_swap(
            payer,
            sa_authority,
            source_token_account,
    ...
    // after swap hook
    let (actual_amount_out, to_commission_amount, to_platform_fee_amount) = swap_processor
        .after_swap(
            payer,
            sa_authority,
            destination_token_account,
    ...
    let (commission_amount, platform_fee_amount) = if commission_direction {
        (from_commission_amount, from_platform_fee_amount)
    } else {
        (to_commission_amount, to_platform_fee_amount)
    };
    Ok((source_token_change, destination_token_change, commission_amount, platform_fee_amount))
}
...
fn execute_swap<'info>(
    ...
    require!(actual_amount_in > 0, ErrorCode::AmountInMustBeGreaterThanZero);
    // min_return can be 0 to support 100% slippage tolerance
    ...
    require!(total_amounts == actual_amount_in, ErrorCode::TotalAmountsMustBeEqualToAmountIn);
...
#[cfg_attr(feature = "log-metrics", dex_macros::log_metrics(dex))]
fn distribute_swap<'a>(
    ...
    let swap_function = match dex {
        ...
        Dex::JupiterLendDeposit => jupiter_lend::deposit_handler,
        Dex::JupiterLendRedeem => jupiter_lend::redeem_handler,
        Dex::TaurusFi => taurusfi::swap,
        Dex::BisonFi => bisonfi::swap,
        Dex::GoonfiV2 => goonfi_v2::swap,
        Dex::Quantum => quantum::swap,
        Dex::BoopfunBuy2 => {
            return boopfun2::buy(
                remaining_accounts,
                amount_in,
        ...
        Dex::BoopfunSell2 => boopfun2::sell,
        Dex::ByrealClmm2 => byreal_clmm2::swap_v2,
        Dex::Dooar2 => dooar2::swap,
        Dex::HeavenBuy2 => heaven2::buy,
        Dex::HeavenSell2 => heaven2::sell,
        Dex::MoonitBuy2 => {
            return moonit2::buy(
                remaining_accounts,
                amount_in,
        ...
        Dex::MoonitSell2 => moonit2::sell,
        Dex::SaberDecimalWrapperDeposit2 => saber_decimal_wrapper2::deposit,
