...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.metadata_state.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_state.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.pool_auth_pubkey.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_token_in_account.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_token_out_account.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.metadata_swap_fee_account.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.referrer_token_account.key(), false));
