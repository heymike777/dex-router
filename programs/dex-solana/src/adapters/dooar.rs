...
pub struct DooarAccounts<'info> {
    ...
    pub user_transfer_authority: &'info AccountInfo<'info>, // unused
    pub user_source: &'info AccountInfo<'info>,             // unused
    pub pool_source: &'info AccountInfo<'info>,
    pub pool_destination: &'info AccountInfo<'info>,
    pub user_destination: &'info AccountInfo<'info>, // unused
...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_swap.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.pool_source.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_destination.key(), false));
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.refund_to.key(), false));
    let account_infos = [
