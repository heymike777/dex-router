...
pub fn place_take_order<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.market_authority.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.bids.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.asks.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.market_base_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.market_quote_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.event_heap.key(), false));
    accounts.push(AccountMeta::new(user_base_account.key(), false));
    accounts.push(AccountMeta::new(user_quote_account.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.oracle_a.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.oracle_b.key(), false));
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.open_orders_admin.key(), false));
    ...
    account_infos.push(swap_accounts.market_authority.to_account_info());
    account_infos.push(swap_accounts.bids.to_account_info());
    account_infos.push(swap_accounts.asks.to_account_info());
    account_infos.push(swap_accounts.market_base_vault.to_account_info());
    account_infos.push(swap_accounts.market_quote_vault.to_account_info());
    account_infos.push(swap_accounts.event_heap.to_account_info());
    ...
    account_infos.push(swap_accounts.oracle_a.to_account_info());
    account_infos.push(swap_accounts.oracle_b.to_account_info());
    ...
    account_infos.push(swap_accounts.open_orders_admin.to_account_info());
