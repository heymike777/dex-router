...
pub struct PerpetualsAccount<'info> {
    ...
    pub custody_token_account: &'info AccountInfo<'info>,
...
pub struct PerpetualsSwapAccount<'info> {
    ...
    pub receiving_custody_token_account: &'info AccountInfo<'info>,
    ...
    pub dispensing_custody_token_account: &'info AccountInfo<'info>,
    pub token_program: &'info AccountInfo<'info>,
    pub event_authority: &'info AccountInfo<'info>,
...
impl<'info> PerpetualsSwapAccount<'info> {
    ...
    fn get_accountinfos(&self) -> [AccountInfo<'info>; PERPETUALS_SWAP_ACCOUNTS_LEN] {
        [
            self.owner.to_account_info(),
