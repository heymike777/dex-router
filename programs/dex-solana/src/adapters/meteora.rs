...
pub fn deposit<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.token_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.lp_mint.key(), false));
...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new(swap_source_token, false));
    accounts.push(AccountMeta::new(swap_destination_token, false));
    accounts.push(AccountMeta::new(swap_accounts.a_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.b_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.a_token_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.b_token_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.a_vault_lp_mint.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.b_vault_lp_mint.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.a_vault_lp.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.b_vault_lp.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.admin_token_fee.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.swap_authority_pubkey.key(), true));
    accounts.push(AccountMeta::new_readonly(swap_accounts.vault_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_program.key(), false));
...
pub fn swap_lst<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.vault_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.lst.key(), false));
...
pub fn dlmm_swap<'a>(
    ...
    accounts.push(AccountMeta::new(swap_source_token, false));
    accounts.push(AccountMeta::new(swap_destination_token, false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_x_mint.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_y_mint.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.oracle.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.host_fee_in.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.swap_authority_pubkey.key(), true));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_x_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_y_program.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.bin_array0.key(), false));

    let mut account_infos = arrayvec::ArrayVec::<_, 18>::new();
    account_infos.push(swap_accounts.lb_pair.to_account_info());
    account_infos.push(swap_accounts.bin_array_bitmap_extension.to_account_info());
    account_infos.push(swap_accounts.reserve_x.to_account_info());
    account_infos.push(swap_accounts.reserve_y.to_account_info());
    ...
    account_infos.push(swap_accounts.token_x_mint.to_account_info());
    account_infos.push(swap_accounts.token_y_mint.to_account_info());
    account_infos.push(swap_accounts.oracle.to_account_info());
    account_infos.push(swap_accounts.host_fee_in.to_account_info());
    account_infos.push(swap_accounts.swap_authority_pubkey.to_account_info());
    account_infos.push(swap_accounts.token_x_program.to_account_info());
    account_infos.push(swap_accounts.token_y_program.to_account_info());
    ...
    account_infos.push(swap_accounts.bin_array0.to_account_info());
...
pub fn damm_v2_swap<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.pool.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.input_token_account.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.output_token_account.key(), false));
...
pub fn damm_v2_swap2<'a>(
    ...
    let mut account_infos = arrayvec::ArrayVec::<_, DAMMV2_SWAP2_ACCOUNTS_LEN>::new();
