...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.trading_pair.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.second_reference_oracle.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.third_reference_oracle.key(), false));
    ...
    accounts.push(AccountMeta::new(user_token_account_x.key(), false));
    accounts.push(AccountMeta::new(user_token_account_y.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.reference_oracle.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.x_price_feed.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.y_price_feed.key(), false));
