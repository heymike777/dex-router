...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.authority_acc_info.key(), false));
    ...
    accounts.push(AccountMeta::new(pool_destination_pubkey, false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.pool_fee.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.source_mint.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.destination_mint.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.source_token_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.destination_token_program.key(), false));
