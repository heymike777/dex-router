...
pub struct MoonitAccounts<'info> {
    ...
    pub sender: &'info AccountInfo<'info>, // unused
    pub sender_token_account: &'info AccountInfo<'info>, // unused
...
pub fn buy<'a>(
    ...
    let mut account_metas = Vec::with_capacity(11);
    account_metas.push(AccountMeta::new(swap_accounts.swap_authority_pubkey.key(), true));
    account_metas.push(AccountMeta::new(swap_accounts.swap_destination_token.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.curve_account.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.curve_token_account.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.dex_fee.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.helio_fee.key(), false));
    account_metas.push(AccountMeta::new_readonly(swap_accounts.mint.key(), false));
    account_metas.push(AccountMeta::new_readonly(swap_accounts.config_account.key(), false));
    account_metas.push(AccountMeta::new_readonly(swap_accounts.token_program.key(), false));
    account_metas
...
pub fn sell<'a>(
    ...
    let mut account_metas = Vec::with_capacity(11);
    account_metas.push(AccountMeta::new(swap_accounts.swap_authority_pubkey.key(), true));
    account_metas.push(AccountMeta::new(swap_accounts.swap_source_token.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.curve_account.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.curve_token_account.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.dex_fee.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.helio_fee.key(), false));
    ...
    let dex_processor = MoonitSellProcessor {
        sender_before_lamports: swap_accounts.swap_authority_pubkey.lamports(),
    };
    let amount_out = invoke_process(
        amount_in,
        &dex_processor,
