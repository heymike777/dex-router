...
pub struct SaberDecimalWrapperAccounts<'info> {
    ...
    pub owner: &'info AccountInfo<'info>, // unused
    pub user_underlying_tokens: &'info AccountInfo<'info>, // unused
    pub user_wrapped_tokens: &'info AccountInfo<'info>, // unused
...
pub fn deposit<'a>(
    ...
    let mut account_meta = Vec::with_capacity(7);
    account_meta.push(AccountMeta::new_readonly(swap_accounts.wrapper.key(), false));
    account_meta.push(AccountMeta::new(swap_accounts.wrapper_mint.key(), false));
    account_meta.push(AccountMeta::new(swap_accounts.wrapper_underlying_tokens.key(), false));
    account_meta.push(AccountMeta::new(swap_accounts.swap_authority_pubkey.key(), true));
    account_meta.push(AccountMeta::new(swap_accounts.swap_source_token.key(), false));
    account_meta.push(AccountMeta::new(swap_accounts.swap_destination_token.key(), false));
    account_meta.push(AccountMeta::new_readonly(swap_accounts.token_program.key(), false));
