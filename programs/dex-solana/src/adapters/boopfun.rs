...
pub struct BoopfunBuyAccounts<'info> {
    ...
    pub bonding_curve_vault: &'info AccountInfo<'info>,
...
pub struct BoopfunSellAccounts<'info> {
    ...
    pub bonding_curve_vault: &'info AccountInfo<'info>,
    pub bonding_curve_sol_vault: &'info AccountInfo<'info>,
    pub seller_token_account: &'info AccountInfo<'info>, // unused
    pub seller: &'info AccountInfo<'info>,               // unused
    pub recipient: &'info AccountInfo<'info>,            // unused
    pub config: &'info AccountInfo<'info>,
    pub system_program: &'info AccountInfo<'info>,
    pub token_program: &'info AccountInfo<'info>,
    pub associated_token_program: &'info AccountInfo<'info>,
...
pub fn buy<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.trading_fees_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.bonding_curve_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.bonding_curve_sol_vault.key(), false));
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.config.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.vault_authority.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.wsol.key(), false));
...
pub fn sell<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.swap_authority_pubkey.key(), true));
    accounts.push(AccountMeta::new(swap_accounts.swap_authority_pubkey.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.config.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.system_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.associated_token_program.key(), false));
