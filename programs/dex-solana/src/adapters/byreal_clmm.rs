...
pub struct ByrealClmmSwapV2Accounts<'info> {
    ...
    pub payer: &'info AccountInfo<'info>, // unused
    pub amm_config: &'info AccountInfo<'info>,
    pub pool_state: &'info AccountInfo<'info>,
    pub input_token_account: &'info AccountInfo<'info>, // unused
    pub output_token_account: &'info AccountInfo<'info>, // unused
...
pub fn swap_v2<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_program_2022.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.tickarray_bitmap_extension.key(), false));

    let mut account_infos = arrayvec::ArrayVec::<_, 20>::new();
    account_infos.push(swap_accounts.swap_authority_pubkey.to_account_info());
    account_infos.push(swap_accounts.amm_config.to_account_info());
    ...
    account_infos.push(swap_accounts.observation_state.to_account_info());
    ...
    account_infos.push(swap_accounts.tickarray_bitmap_extension.to_account_info());
