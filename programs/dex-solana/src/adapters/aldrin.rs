...
pub fn swap_v1<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.pool_info.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.pool_coin_token_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_pc_token_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_fee_account.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.swap_authority_pubkey.key(), true));
    accounts.push(AccountMeta::new(user_coin_token_acc, false));
    accounts.push(AccountMeta::new(user_pc_token_acc, false));
...
pub fn swap_v2<'a>(
    ...
    accounts.push(AccountMeta::new(user_coin_token_acc, false));
    accounts.push(AccountMeta::new(user_pc_token_acc, false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.pool_curve.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_program.key(), false));
