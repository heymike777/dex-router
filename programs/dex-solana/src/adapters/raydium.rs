...
pub struct RaydiumSwapAccounts<'info> {
    ...
    pub pool_coin_token_account: &'info AccountInfo<'info>,
    pub pool_pc_token_account: &'info AccountInfo<'info>,
    ...
    pub serum_coin_vault_account: &'info AccountInfo<'info>,
    pub serum_pc_vault_account: &'info AccountInfo<'info>,
...
pub struct RaydiumCpmmAccounts<'info> {
    ...
    pub input_token_mint: &'info AccountInfo<'info>,
    pub output_token_mint: &'info AccountInfo<'info>,
...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.amm_authority.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.amm_open_orders.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.amm_target_orders.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_coin_token_account.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_pc_token_account.key(), false));
    accounts.push(
        // serum
        AccountMeta::new_readonly(swap_accounts.serum_program_id.key(), false),
    );
    accounts.push(AccountMeta::new(swap_accounts.serum_market.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.serum_bids.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.serum_asks.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.serum_event_queue.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.serum_coin_vault_account.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.serum_pc_vault_account.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.serum_vault_signer.key(), false));
    accounts.push(
        // user
...
pub fn swap_v2<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.amm_id.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.amm_authority.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_coin_token_account.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_pc_token_account.key(), false));
...
pub fn swap_stable<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.pool_coin_token_account.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_pc_token_account.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.model_data_account.key(), false));
    accounts.push(
        // serum
        AccountMeta::new_readonly(swap_accounts.serum_program_id.key(), false),
    );
...
pub fn swap_clmm<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.amm_config_id.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_id.key(), false));
    accounts.push(AccountMeta::new(swap_source_token, false));
    accounts.push(AccountMeta::new(swap_destination_token, false));
    accounts.push(AccountMeta::new(swap_accounts.input_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.output_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.observation_id.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_program.key(), false)); // spl token
    accounts.push(AccountMeta::new(swap_accounts.tick_array0.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.ex_bitmap.key(), false));

    let mut account_infos = arrayvec::ArrayVec::<_, 13>::new();
    account_infos.push(swap_accounts.swap_authority_pubkey.to_account_info());
    account_infos.push(swap_accounts.amm_config_id.to_account_info());
    account_infos.push(swap_accounts.pool_id.to_account_info());
    ...
    account_infos.push(swap_accounts.input_vault.to_account_info());
    account_infos.push(swap_accounts.output_vault.to_account_info());
    account_infos.push(swap_accounts.observation_id.to_account_info());
    ...
    account_infos.push(swap_accounts.ex_bitmap.to_account_info());
...
pub fn swap_clmm_v2<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.observation_id.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_program.key(), false)); // spl token
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_program_2022.key(), false)); // token 2022
    accounts.push(AccountMeta::new_readonly(swap_accounts.memo_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.input_vault_mint.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.output_vault_mint.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.ex_bitmap.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.tick_array0.key(), false));

    let mut account_infos = arrayvec::ArrayVec::<_, 17>::new();
    account_infos.push(swap_accounts.swap_authority_pubkey.to_account_info());
    account_infos.push(swap_accounts.amm_config_id.to_account_info());
    account_infos.push(swap_accounts.pool_id.to_account_info());
    account_infos.push(swap_accounts.swap_source_token.to_account_info());
    ...
    account_infos.push(swap_accounts.observation_id.to_account_info());
    account_infos.push(swap_accounts.token_program.to_account_info());
    account_infos.push(swap_accounts.token_program_2022.to_account_info());
    account_infos.push(swap_accounts.memo_program.to_account_info());
    account_infos.push(swap_accounts.input_vault_mint.to_account_info());
    account_infos.push(swap_accounts.output_vault_mint.to_account_info());
    account_infos.push(swap_accounts.ex_bitmap.to_account_info());
    account_infos.push(swap_accounts.tick_array0.to_account_info());
...
pub fn swap_cpmm<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.authority.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.amm_config.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_state.key(), false));
    accounts.push(AccountMeta::new(swap_source_token, false));
    accounts.push(AccountMeta::new(swap_destination_token, false));
    accounts.push(AccountMeta::new(swap_accounts.input_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.output_vault.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.input_token_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.output_token_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.input_token_mint.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.output_token_mint.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.observation_state.key(), false));
