...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.whirlpool.key(), false));
    accounts.push(AccountMeta::new(token_owner_account_a.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.token_vault_a.key(), false));
    accounts.push(AccountMeta::new(token_owner_account_b.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.token_vault_b.key(), false));
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.oracle.key(), false));
...
pub fn swap_v2<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.swap_authority_pubkey.key(), true));
    accounts.push(AccountMeta::new(swap_accounts.whirlpool.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_mint_a.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_mint_b.key(), false));
    accounts.push(AccountMeta::new(token_owner_account_a.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.token_vault_a.key(), false));
    accounts.push(AccountMeta::new(token_owner_account_b.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.token_vault_b.key(), false));
