...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.wooficonfig.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.token_a_wooracle.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.token_a_woopool.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.token_a_price_update.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.token_b_wooracle.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.token_b_woopool.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.token_b_price_update.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.quote_pool.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.quote_price_update.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.quote_token_vault.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.rebate_to.key(), false));
