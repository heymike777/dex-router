...
const ADD_LST_LIQ_ACCOUNTS_LEN: usize = 19;
const ADD_WSOL_LIQ_ACCOUNTS_LEN: usize = 15;
...
const SWAP_LST_SOL_ACCOUNTS_LEN: usize = 21;
const SWAP_LST_LST_ACCOUNTS_LEN: usize = 25;
...
pub struct SanctumAddLstLiqAccounts<'info> {
    ...
    pub lst_mint: &'info AccountInfo<'info>,
    pub source_lst_acc: InterfaceAccount<'info, TokenAccount>,
    pub dst_lp_acc: InterfaceAccount<'info, TokenAccount>,
    pub lp_token_mint: &'info AccountInfo<'info>,
    pub protocol_fee_accumulator: &'info AccountInfo<'info>,
    pub lst_token_program: &'info AccountInfo<'info>,
    ...
    pub sanctum_flatslab_pricing: &'info AccountInfo<'info>,
    pub slab: &'info AccountInfo<'info>,
}
...
pub struct SanctumRemoveLstLiqAccounts<'info> {
    ...
    pub swap_authority_pubkey: &'info AccountInfo<'info>,
    pub lst_mint: &'info AccountInfo<'info>,
    pub dst_lst_acc: InterfaceAccount<'info, TokenAccount>,
    pub source_lp_acc: InterfaceAccount<'info, TokenAccount>,
    pub lp_token_mint: &'info AccountInfo<'info>,
    pub protocol_fee_accumulator: &'info AccountInfo<'info>,
    pub lst_token_program: &'info AccountInfo<'info>,
    pub lp_token_program: &'info AccountInfo<'info>,
...
pub struct SanctumWsolLstSwapAccounts<'info> {
    pub dex_program_id: &'info AccountInfo<'info>,
    pub swap_authority_pubkey: &'info AccountInfo<'info>,
    pub source_lst_mint: &'info AccountInfo<'info>,
    pub dst_lst_mint: &'info AccountInfo<'info>,
    pub source_lst_account: InterfaceAccount<'info, TokenAccount>,
    pub dst_lst_account: InterfaceAccount<'info, TokenAccount>,
    pub protocol_fee_accumulator: &'info AccountInfo<'info>,
    pub source_token_program: &'info AccountInfo<'info>,
    pub dst_token_program: &'info AccountInfo<'info>,
    pub pool_state: &'info AccountInfo<'info>,
    pub lst_states_list: &'info AccountInfo<'info>,
        ...
        match is_wsol {
            true => {
                ...
                Ok(SanctumAddLiqAccounts::WSOL(SanctumAddWsolLiqAccounts {
                    ...
                    swap_authority_pubkey,
                    lst_mint,
                    source_lst_acc: InterfaceAccount::try_from(source_lst_acc)?,
                    lp_token_mint,
                    dst_lp_acc: InterfaceAccount::try_from(dst_lp_acc)?,
                    protocol_fee_accumulator,
                    lst_token_program,
                    lp_token_program,
                    pool_state,
        ...
        match is_wsol {
            true => {
                ...
                Ok(SanctumRemoveLiqAccounts::WSOL(SanctumRemoveWsolLiqAccounts {
                    ...
                    swap_authority_pubkey,
                    lst_mint,
                    dst_lst_acc: InterfaceAccount::try_from(dst_lst_acc)?,
                    source_lp_acc: InterfaceAccount::try_from(source_lp_acc)?,
                    lp_token_mint,
                    protocol_fee_accumulator,
                    lst_token_program,
                    lp_token_program,
        ...
        match (is_src_wsol, is_dst_wsol) {
            (false, false) => {
                ...
                Ok(SanctumSwapAccounts::LstLst(SanctumLstLstSwapAccounts {
                    ...
                    source_lst_mint,
                    dst_lst_mint,
                    source_lst_account: InterfaceAccount::try_from(source_lst_account)?,
                    dst_lst_account: InterfaceAccount::try_from(dst_lst_account)?,
                    protocol_fee_accumulator,
                    source_token_program,
                    dst_token_program,
                    pool_state,
...
fn handle_prechecks<'info, const N: usize>(
    swap_accounts: &impl CommonAccountInfo<'info, N>,
    hop_accounts: &mut HopAccounts,
    hop: usize,
    proxy_swap: bool,
    owner_seeds: Option<&[&[&[u8]]]>,
...
trait CommonAccountInfo<'info, const N: usize> {
    fn dex_program_id(&self) -> &AccountInfo<'info>;
    fn swap_authority_pubkey(&self) -> &AccountInfo<'info>;
    fn source_token_account(&self) -> &InterfaceAccount<'info, TokenAccount>;
    ...
    fn get_account_infos(&self) -> [AccountInfo<'info>; N];
}

impl<'info> CommonAccountInfo<'info, { ADD_LST_LIQ_ACCOUNTS_LEN - 1 }>
    for SanctumAddLstLiqAccounts<'info>
{
    fn dex_program_id(&self) -> &AccountInfo<'info> {
        &self.dex_program_id
    }
    ...
    fn get_accountmetas(&self) -> Vec<AccountMeta> {
        let mut account_metas = Vec::with_capacity(18);
        account_metas.push(AccountMeta::new(self.swap_authority_pubkey.key(), true));
        account_metas.push(AccountMeta::new_readonly(self.lst_mint.key(), false));
        account_metas.push(AccountMeta::new(self.source_lst_acc.key(), false));
        account_metas.push(AccountMeta::new(self.dst_lp_acc.key(), false));
        account_metas.push(AccountMeta::new(self.lp_token_mint.key(), false));
        account_metas.push(AccountMeta::new(self.protocol_fee_accumulator.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.lst_token_program.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.lp_token_program.key(), false));
        account_metas.push(AccountMeta::new(self.pool_state.key(), false));
        account_metas.push(AccountMeta::new(self.lst_states_list.key(), false));
        account_metas.push(AccountMeta::new(self.pool_reserves.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.spl_sol_calculator.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.calculator_state.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.staked_pool_state.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.validator_pool_program.key(), false));
        account_metas
            .push(AccountMeta::new_readonly(self.validator_pool_program_data.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.sanctum_flatslab_pricing.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.slab.key(), false));
        account_metas
    }
    fn get_account_infos(&self) -> [AccountInfo<'info>; ADD_LST_LIQ_ACCOUNTS_LEN - 1] {
        [
            ...
            self.sanctum_flatslab_pricing.to_account_info(),
            self.slab.to_account_info(),
        ]
    }
}

impl<'info> CommonAccountInfo<'info, { ADD_WSOL_LIQ_ACCOUNTS_LEN - 1 }>
    for SanctumAddWsolLiqAccounts<'info>
{
    fn dex_program_id(&self) -> &AccountInfo<'info> {
        &self.dex_program_id
    }
    ...
    fn get_accountmetas(&self) -> Vec<AccountMeta> {
        ...
        account_metas.push(AccountMeta::new(self.lst_states_list.key(), false));
        account_metas.push(AccountMeta::new(self.pool_reserves.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.wsol_calculator.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.sanctum_flatslab_pricing.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.slab.key(), false));
        account_metas
    }
    fn get_account_infos(&self) -> [AccountInfo<'info>; ADD_WSOL_LIQ_ACCOUNTS_LEN - 1] {
        [
            self.swap_authority_pubkey.to_account_info(),
            self.lst_mint.to_account_info(),
            self.source_lst_acc.to_account_info(),
...
impl<'info> CommonAccountInfo<'info, { REMOVE_WSOL_LIQ_ACCOUNTS_LEN - 1 }>
    for SanctumRemoveWsolLiqAccounts<'info>
{
    fn dex_program_id(&self) -> &AccountInfo<'info> {
        &self.dex_program_id
    }
    ...
    fn get_accountmetas(&self) -> Vec<AccountMeta> {
        ...
        account_metas.push(AccountMeta::new(self.swap_authority_pubkey.key(), true));
        account_metas.push(AccountMeta::new_readonly(self.lst_mint.key(), false));
        account_metas.push(AccountMeta::new(self.dst_lst_acc.key(), false));
        account_metas.push(AccountMeta::new(self.source_lp_acc.key(), false));
        account_metas.push(AccountMeta::new(self.lp_token_mint.key(), false));
        account_metas.push(AccountMeta::new(self.protocol_fee_accumulator.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.lst_token_program.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.lp_token_program.key(), false));
    ...
    fn get_account_infos(&self) -> [AccountInfo<'info>; REMOVE_WSOL_LIQ_ACCOUNTS_LEN - 1] {
        [
            self.swap_authority_pubkey.to_account_info(),
            self.lst_mint.to_account_info(),
...
impl<'info> CommonAccountInfo<'info, { REMOVE_LST_LIQ_ACCOUNTS_LEN - 1 }>
    for SanctumRemoveLstLiqAccounts<'info>
{
    fn dex_program_id(&self) -> &AccountInfo<'info> {
        &self.dex_program_id
    }
    ...
    fn get_account_infos(&self) -> [AccountInfo<'info>; REMOVE_LST_LIQ_ACCOUNTS_LEN - 1] {
        [
            self.swap_authority_pubkey.to_account_info(),
            self.lst_mint.to_account_info(),
            self.dst_lst_acc.to_account_info(),
...
impl<'info> CommonAccountInfo<'info, { SWAP_LST_SOL_ACCOUNTS_LEN - 1 }>
    for SanctumWsolLstSwapAccounts<'info>
{
    fn dex_program_id(&self) -> &AccountInfo<'info> {
        &self.dex_program_id
    }
    ...
    fn get_accountmetas(&self) -> Vec<AccountMeta> {
        let mut account_metas = Vec::with_capacity(20);
        account_metas.push(AccountMeta::new(self.swap_authority_pubkey.key(), true));
        account_metas.push(AccountMeta::new_readonly(self.source_lst_mint.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.dst_lst_mint.key(), false));
        account_metas.push(AccountMeta::new(self.source_lst_account.key(), false));
        account_metas.push(AccountMeta::new(self.dst_lst_account.key(), false));
        account_metas.push(AccountMeta::new(self.protocol_fee_accumulator.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.source_token_program.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.dst_token_program.key(), false));
        account_metas.push(AccountMeta::new(self.pool_state.key(), false));
        account_metas.push(AccountMeta::new(self.lst_states_list.key(), false));
        account_metas.push(AccountMeta::new(self.source_pool_reserves.key(), false));
        account_metas.push(AccountMeta::new(self.dst_pool_reserves.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.wsol_calculator.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.spl_sol_calculator.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.calculator_state.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.staked_pool_state.key(), false));
    ...
    fn get_account_infos(&self) -> [AccountInfo<'info>; SWAP_LST_SOL_ACCOUNTS_LEN - 1] {
        [
            self.swap_authority_pubkey.to_account_info(),
...
impl<'info> CommonAccountInfo<'info, { SWAP_LST_SOL_ACCOUNTS_LEN - 1 }>
    for SanctumLstWsolSwapAccounts<'info>
{
    fn dex_program_id(&self) -> &AccountInfo<'info> {
        &self.dex_program_id
    }
...
impl<'info> CommonAccountInfo<'info, { SWAP_LST_LST_ACCOUNTS_LEN - 1 }>
    for SanctumLstLstSwapAccounts<'info>
{
    fn dex_program_id(&self) -> &AccountInfo<'info> {
        &self.dex_program_id
    }
    ...
    fn get_accountmetas(&self) -> Vec<AccountMeta> {
        let mut account_metas = Vec::with_capacity(24);
        account_metas.push(AccountMeta::new(self.swap_authority_pubkey.key(), true));
        account_metas.push(AccountMeta::new_readonly(self.source_lst_mint.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.dst_lst_mint.key(), false));
        account_metas.push(AccountMeta::new(self.source_lst_account.key(), false));
        ...
        account_metas.push(AccountMeta::new(self.source_pool_reserves.key(), false));
        account_metas.push(AccountMeta::new(self.dst_pool_reserves.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.src_spl_sol_calculator.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.src_calculator_state.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.src_staked_pool_state.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.src_validator_pool_program.key(), false));
        account_metas
            .push(AccountMeta::new_readonly(self.src_validator_pool_program_data.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.dst_spl_sol_calculator.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.dst_calculator_state.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.dst_staked_pool_state.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.dst_validator_pool_program.key(), false));
        account_metas
            .push(AccountMeta::new_readonly(self.dst_validator_pool_program_data.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.sanctum_flatslab_pricing.key(), false));
        account_metas.push(AccountMeta::new_readonly(self.slab.key(), false));
        account_metas
    }
    fn get_account_infos(&self) -> [AccountInfo<'info>; SWAP_LST_LST_ACCOUNTS_LEN - 1] {
        [
            self.swap_authority_pubkey.to_account_info(),
            self.source_lst_mint.to_account_info(),
            self.dst_lst_mint.to_account_info(),
