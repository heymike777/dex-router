...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.vpool.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_mint.key(), false));
    accounts.push(AccountMeta::new(user_virtuals_account_info.key(), false));
    accounts.push(AccountMeta::new(user_token_account_info.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.vpool_token_ata.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.platform_prototype.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.platform_prototype_virtuals_ata.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.vpool_virtuals_ata.key(), false));
