...
pub struct LifinitySwapAccountsV2<'info> {
    ...
    pub swap_source: &'info AccountInfo<'info>,
    pub swap_destination: &'info AccountInfo<'info>,
...
pub fn swap_v2<'a>(
    ...
    accounts.push(AccountMeta::new(swap_accounts.amm_info.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.swap_source.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.swap_destination.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_mint.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.fee_account.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_program.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.oracle_main_account.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.oracle_sub_account.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.oracle_pc_account.key(), false));
