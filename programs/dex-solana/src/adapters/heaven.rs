...
pub struct HeavenSwapAccounts<'info> {
    ...
    pub user: &'info AccountInfo<'info>, // unused
    pub token_a_mint: &'info AccountInfo<'info>,
    pub token_b_mint: &'info AccountInfo<'info>,
    pub user_token_a_vault: &'info AccountInfo<'info>, // unused
    pub user_token_b_vault: &'info AccountInfo<'info>, // unused
...
pub fn swap_handler<'a>(
    ...
    let (user_token_a_vault, user_token_b_vault) = if is_buy {
    ...
    let mut account_metas = Vec::with_capacity(16);
    account_metas.push(AccountMeta::new_readonly(swap_accounts.token_a_program.key(), false));
    account_metas.push(AccountMeta::new_readonly(swap_accounts.token_b_program.key(), false));
    account_metas
        .push(AccountMeta::new_readonly(swap_accounts.associated_token_program.key(), false));
    account_metas.push(AccountMeta::new_readonly(swap_accounts.system_program.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.liquidity_pool_state.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.swap_authority_pubkey.key(), true));
    account_metas.push(AccountMeta::new_readonly(swap_accounts.token_a_mint.key(), false));
    account_metas.push(AccountMeta::new_readonly(swap_accounts.token_b_mint.key(), false));
    account_metas.push(AccountMeta::new(user_token_a_vault.key(), false));
    account_metas.push(AccountMeta::new(user_token_b_vault.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.token_a_vault.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.token_b_vault.key(), false));
    account_metas.push(AccountMeta::new(swap_accounts.protocol_config.key(), false));
    account_metas.push(AccountMeta::new_readonly(
        swap_accounts.instruction_sysvar_account_info.key(),
        false,
    ));
    account_metas.push(AccountMeta::new_readonly(swap_accounts.chainlink_program.key(), false));
    account_metas
        .push(AccountMeta::new_readonly(swap_accounts.chainlink_sol_usd_feed.key(), false));
    ...
    let account_infos = [
        ...
        user_token_a_vault.to_account_info(),
        user_token_b_vault.to_account_info(),
