...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.mint_in.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.mint_out.key(), false));
    ...
    accounts.push(AccountMeta::new(swap_accounts.vault_token_in.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.vault_token_out.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.beneficiary_token_out.key(), false));
    accounts.push(AccountMeta::new(swap_accounts.pool_token_in.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.withdraw_authority.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.vault.key(), false));
    accounts.push(AccountMeta::new_readonly(swap_accounts.vault_authority.key(), false));
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.token_2022_program.key(), false));
