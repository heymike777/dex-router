...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new(in_mint_key, false));
    accounts.push(AccountMeta::new(out_mint_key, false));
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.numeraire_config.key(), false));
