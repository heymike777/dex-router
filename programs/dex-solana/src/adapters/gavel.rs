...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.log_authority.key(), false));
    ...
    accounts.push(AccountMeta::new(user_base_token_account.key(), false));
    accounts.push(AccountMeta::new(user_quote_token_account.key(), false));
