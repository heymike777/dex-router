...
pub fn swap<'a>(
    ...
    accounts.push(AccountMeta::new_readonly(swap_accounts.swap_authority_pubkey.key(), true)); // payer (signer)
    accounts.push(AccountMeta::new_readonly(swap_accounts.authority.key(), false)); // authority
    accounts.push(AccountMeta::new_readonly(swap_accounts.amm_config.key(), false)); // amm_config
    accounts.push(AccountMeta::new(swap_accounts.pool_state.key(), false)); // pool_state
    accounts.push(AccountMeta::new(swap_accounts.swap_source_token.key(), false)); // input_token_account
    accounts.push(AccountMeta::new(swap_accounts.swap_destination_token.key(), false)); // output_token_account
    accounts.push(AccountMeta::new(swap_accounts.input_vault.key(), false)); // input_vault
    accounts.push(AccountMeta::new(swap_accounts.output_vault.key(), false)); // output_vault
    accounts.push(AccountMeta::new_readonly(swap_accounts.input_token_program.key(), false)); // input_token_program
    accounts.push(AccountMeta::new_readonly(swap_accounts.output_token_program.key(), false)); // output_token_program
    accounts.push(AccountMeta::new_readonly(swap_accounts.input_token_mint.key(), false)); // input_token_mint
    accounts.push(AccountMeta::new_readonly(swap_accounts.output_token_mint.key(), false)); // output_token_mint
    accounts.push(AccountMeta::new(swap_accounts.observation_state.key(), false)); // observation_state
